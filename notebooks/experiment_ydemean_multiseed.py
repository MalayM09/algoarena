...
print('Recomputing Spearman IC over all_gold features with y_dm target...', flush=True)
...
print(f'grin_all_dm (weights from y_dm): IC={grin_all_dm_ic:+.6f}', flush=True)

print('\n=== LIGHTGBM MULTI-SEED (trained on y_dm, all 105 features) ===', flush=True)
